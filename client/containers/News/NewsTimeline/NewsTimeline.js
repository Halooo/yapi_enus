...
class NewsTimeline extends Component {
  ...
  render() {
    ...
    let pending = this.state.bidden?<a className={this.state.bidden}>All info is listed above</a>:<a className="loggetMore" onClick = {this.getMore.bind(this)}>See more</a>;
