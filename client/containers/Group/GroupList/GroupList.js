...
const tip = (<div className="title-container">
  <h3 className="title">Welcome to YApi ~</h3>
  <p>Here <b>“Personal Space”</b> is only visible by you, you can discover the functionality of YApi</p>
</div>);
        ...
        <div className="group-bar">
          <div className="curr-group">
            <div className="curr-group-name">
              ...
              { /* 只有超级管理员能添加分组 */
                this.props.curUserRole === 'admin' ? <Tooltip title="Add group"><a className="editSet"><Icon className="btn" type="folder-add" onClick={this.showModal} /></a></Tooltip> : ''
              }
            </div>
            <div className="curr-group-desc">group description: {currGroup.group_desc}</div>
          </div>

          <div className="group-operate">
            <div className="search">
              <Search placeholder="Search group" onChange={this.searchGroup} onSearch={(v) => this.searchGroup(null, v)} />
            </div>
          </div>
          <Menu
        ...
        </div>
        {
          ...
          >
            <Row gutter={6} className="modal-input">
              <Col span="5"><div className="label">Group name：</div></Col>
              <Col span="15">
                <Input placeholder="Please enter group name" onChange={this.inputNewGroupName}></Input>
              </Col>
            </Row>
            <Row gutter={6} className="modal-input">
              <Col span="5"><div className="label">Desc：</div></Col>
              <Col span="15">
                <TextArea rows={3} placeholder="Please enter description for the group" onChange={this.inputNewGroupDesc}></TextArea>
              </Col>
            </Row>
            <Row gutter={6} className="modal-input">
              <Col span="5"><div className="label">Group owner：</div></Col>
              <Col span="15">
