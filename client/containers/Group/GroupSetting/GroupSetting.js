...
class GroupSetting extends Component {
  ...
  showConfirm = () => {
    const that = this;
    confirm({
      title: 'Are you sure to delete ' + that.props.currGroup.group_name + '？',
      content: (
        <div style={{ marginTop: '10px', fontSize: '13px', lineHeight: '25px' }}>
          <Alert
            message="Warning：this is a risky operation, it will delete all projects and APIs under this group and not revertible"
            type="warning"
          />
          <div style={{ marginTop: '16px' }}>
            <p>
              <b>Please enter the group name to confirm deletion:</b>
            </p>
            <Input id="group_name" />
          </div>
        </div>
      ...
      <div className="m-panel card-panel card-panel-s panel-group">
        ...
        <Row type="flex" justify="space-around" className="row" align="middle">
          <Col span={4} className="label">
            ...
            <Tooltip title={'Can add additional parameter'}>
              <Icon type="question-circle-o" style={{ width: '10px' }} />
            </Tooltip> ：
          </Col>
          <Col span={12} style={{ position: 'relative' }}>
            <Input
              placeholder="Please enter name of custom parameter"
            ...
            >
                Name of custom parameter cannot be empty
            </div>
          </Col>
          ...
          <Row type="flex" justify="center" className="danger-container">
            <Col span={24} className="title">
              <h2 className="content">
                <Icon type="exclamation-circle-o" /> Dangerous
              </h2>
            ...
            {this.state.showDangerOptions ? (
              <Card hoverable={true} className="card-danger" style={{ width: '100%' }}>
                <div className="card-danger-content">
                  <h3>Delete Group</h3>
                  <p>Deletion cannot be reverted, please be careful!</p>
                  <p>Only Super Admin can delete Groups</p>
                </div>
