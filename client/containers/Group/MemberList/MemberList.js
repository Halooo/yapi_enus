...
class MemberList extends Component {
    ...
    this.props
      ...
      .then(res => {
        if (!res.payload.data.errcode) {
          ...
          message.success(`Success! Added ${addLength} members, ${existLength} of them are already in the group!`);
  ...
  render() {
    const columns = [
      {
        title:
          this.props.currGroup.group_name + ' Group has (' + this.state.userInfo.length + ') members',
        dataIndex: 'username',
        key: 'username',
        render: (text, record) => {
          return (
            ...
            return (
              <div>
                ...
                >
                  ...
                  <Option value={'dev-' + record.uid}>Developers</Option>
                  <Option value={'guest-' + record.uid}>Guests</Option>
                </Select>
                <Popconfirm
                  placement="topRight"
        ...
        {this.state.visible ? (
          ...
          >
            <Row gutter={6} className="modal-input">
              <Col span="5">
                <div className="label usernamelabel">Username: </div>
              </Col>
              <Col span="15">
            ...
            <Row gutter={6} className="modal-input">
              <Col span="5">
                <div className="label usernameauth">Role: </div>
              </Col>
              <Col span="15">
