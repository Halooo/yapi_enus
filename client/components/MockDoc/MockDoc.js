      ...
      <div className='MockDoc'>
        {
          htmlData.map(function(item,i){
            ...
            if(item.mes){
              var mes = [];
              item.mes.type?mes.push(<span  key = {i} className="keymes"> / /Type：{item.mes.type}</span>):"";
              item.mes.required?mes.push(<span key = {i+1} className="keymes">Required fields</span>):"";
              item.mes.desc?mes.push(<span key = {i+2} className="keymes">Note：{item.mes.desc}</span>):"";
            }
            return (
...
MockDoc.defaultProps = {
  ...
  doc: [
    { type: "strisng", key: "ersrcode", required: true, desc: "Error code" },
    { type: "number", key: "data[]", required: true, desc: "Return data" },
    { type: "object", key: "data[].name", required: true, desc: "Data name" },
    { type: "object", key: "data[].name1[].name3", required: true, desc: "Data name1" },
    { type: "object", key: "data1", required: true, desc: "Data name1" },
    { type: "object", key: "data3.err", required: true, desc: "Data name1" },
    { type: "object", key: "data3", required: true, desc: "Data name1" },
    { type: "object", key: "data3.arr[]", required: true, desc: "Data name1" }
  ]
}
