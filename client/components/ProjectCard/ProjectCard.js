...
class ProjectCard extends Component {
  ...
  showConfirm = () => {
    ...
    confirm({
      title: 'Confirm copy ' + that.props.projectData.name + '?',
      okText: 'Confirm',
      cancelText: 'Cancel',
      content: (
        <div style={{ marginTop: '10px', fontSize: '13px', lineHeight: '25px' }}>
          <Alert
            message={`This will copy all API collections under ${
              that.props.projectData.name
            } , but does not include test API collection`}
            type="info"
          />
    ...
    return (
      <div className="card-container">
        ...
        >
          <Tooltip
            placement="rightTop"
            title={projectData.follow || inFollowPage ? 'Remove Favorite' : 'Add Favorite'}
          >
            <Icon
        ...
        {isShow && (
          <div className="copy-btns" onClick={this.showConfirm}>
            <Tooltip placement="rightTop" title="Copy Project">
