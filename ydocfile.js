module.exports = {
    ...
    "common": { // 通用默认配置，包括主页配置等
        "title": "YApi API Managment Platform", //page title
    ...
    "pages": [
        {
            ...
            "homepage": { // 配置首页，样式区别于其他页面
                ...
                "intro": [{ // 首页的正文部分，数组项依次渲染，可重复使用
                    "title": "Designed For API Developers", // 介绍板块标题
                    "desc": "YApi is a tool that improves team efficiency" // 介绍板块描述
                },{
                    "title": "",
                    "detail": {
                        "type": "thumbnail", // 三列布局的介绍板块
                        "content": [{ // 三列布局的内容，每项的key值非必需，但建议每列的key值一致
                            "name": "Project Management", // 板块名称
                            "src": "./images/intro_page_1.png", // 缩略图
                            "desc": "YApi Team management" // 描述
                        },{
                            "name": "API Management",
                            "src": "./images/intro_page_2.png",
                            "desc": "API Documentation<br>Based on websocket and postman test tool"
                        },{
                            "name": "MockServer",
                            "src": "./images/intro_page_3.png",
                            "desc": "Based on Mockjs<br>Simple but powerful"
                        }]
                    }
                }]
            },
        ...
        "content": {
            ...
            "pages": [{
                ...
                "name": "Create first API",
                "index": "quickstart",
                "content": "./doc/page/usage/quickstart.md"
            },{
                "name": "Manage Project and Group",
                "index": "manage",
